...
const Navbar = () => {
  return (
    <>
      <nav className="fixed top-0 left-0 w-full z-[1000] flex justify-between items-center py-[15px] px-[5%] bg-navbar-gradient text-white font-sans shadow-[0px_4px_10px_rgba(0,0,0,0.2)] box-border h-20 md:flex-col md:p-[15px]">
        ...
        <ul className="list-none flex gap-[30px] flex-wrap mr-[10px] md:mt-[10px] md:flex-col md:gap-[15px] md:text-center">
