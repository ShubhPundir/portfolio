...
const projects: FreelanceProject[] = [
  ...
  },
  {
    ...
    date: "May 2023",
    duration: "4 months",
    techStack: ["Excel", "Python", "Pandas", "R", "SAP", "SQL"],
    ...
    highlights: ["8% MoM Growth", "60% Faster Insights", "5 Regions"],
    flag: "🇮🇳",
    countryCode: "in"
  },
  {
    ...
    impact: "99.9% data integrity across 100k+ monthly transactions. Reduced business intelligence turnaround from days to minutes.",
    highlights: ["100k+ Txn/mo", "99.9% Integrity", "Real-time BI"],
    flag: "🇦🇪",
    countryCode: "ae"
  },
  {
  ...
  },
  {
    ...
    highlights: ["1000+ Daily Listings"],
    flag: "🇪🇹",
    countryCode: "et"
  },
  {
