      ...
      <div className="relative z-10 flex flex-row w-full max-w-7xl items-center gap-12 flex-wrap-reverse md:flex-nowrap">
        ...
        <div className="flex-1 flex flex-col space-y-6 min-w-[300px]">
          ...
          <p className="text-lg md:text-xl leading-relaxed text-gray-300">
            I build <strong className="text-white">production-grade backend systems</strong> for
            <strong className="text-white"> data-heavy and AI-enabled products</strong>, focusing on reliability, scalability, and long-term maintainability.
            My work spans <strong className="text-white">backend engineering, distributed systems, and pragmatic AI integration—using NLP and LLMs</strong> where they
            create measurable operational or business leverage, not novelty.
            <br /><br />
            Since 2020, I’ve delivered <strong className="text-white">12+ paid projects for international clients</strong>,
            often owning systems end-to-end—from architecture and implementation to deployment and iteration in production.
            I work closely with founders and product teams to translate real requirements into backend systems that scale without costly rebuilds.
          </p>
